...
## [](https://github.com/jacaudi/nextdns-operator/releases/tag/) - 0001-01-01
...
- [`8566d3a`](https://github.com/jacaudi/nextdns-operator/commit/8566d3a98470fd3e812c7cb41d35d521d8bd0efc) feat: import profile configuration from ConfigMap JSON (#45)
- [`486595f`](https://github.com/jacaudi/nextdns-operator/commit/486595fdbd760fb541dd5f179e59b71418a8711f) feat: add domain override support to NextDNSCoreDNS (#44)
- [`be8950c`](https://github.com/jacaudi/nextdns-operator/commit/be8950c331df2f19c3531283c899c2a361d065a7) fix: use IP addresses for DoT forward plugin
- [`01e2f33`](https://github.com/jacaudi/nextdns-operator/commit/01e2f331d812614a5bbc127ab5aa662e46acfc8e) style: use fmt.Fprintf instead of WriteString(fmt.Sprintf)
- [`166fc9f`](https://github.com/jacaudi/nextdns-operator/commit/166fc9f703872709b8f5f555600d6f951a1420f1) ci: require verify-helm jobs before container builds
...
- [`3cd5c80`](https://github.com/jacaudi/nextdns-operator/commit/3cd5c80531e4f2aef5c3985d0968f233197d0232) chore: add .worktrees to gitignore
- [`8a698e7`](https://github.com/jacaudi/nextdns-operator/commit/8a698e742f9d597702f68786086aa82aa5bb8279) chore(deps): migrate to shared renovate config (#23)
- [`945b725`](https://github.com/jacaudi/nextdns-operator/commit/945b725b88e8689fa98cbae62e1e2a835c609e06) fix(ci): update github-actions to v0.7.0
...
- [`8a698e7`](https://github.com/jacaudi/nextdns-operator/commit/8a698e742f9d597702f68786086aa82aa5bb8279) chore(deps): migrate to shared renovate config (#23)
- [`945b725`](https://github.com/jacaudi/nextdns-operator/commit/945b725b88e8689fa98cbae62e1e2a835c609e06) fix(ci): update github-actions to v0.7.0
- [`7aaf5c9`](https://github.com/jacaudi/nextdns-operator/commit/7aaf5c9ab652c392f39d637c5280501aa3696b34) feat(ci): add version validation before helm publish
...
- [`945b725`](https://github.com/jacaudi/nextdns-operator/commit/945b725b88e8689fa98cbae62e1e2a835c609e06) fix(ci): update github-actions to v0.7.0
- [`7aaf5c9`](https://github.com/jacaudi/nextdns-operator/commit/7aaf5c9ab652c392f39d637c5280501aa3696b34) feat(ci): add version validation before helm publish
- [`af8a237`](https://github.com/jacaudi/nextdns-operator/commit/af8a23739163cee4fee9c6b9d54574e5833ed89d) fix(ci): update github-actions to v0.6.0 for appVersion fix
- [`f77a508`](https://github.com/jacaudi/nextdns-operator/commit/f77a5084ca82de37d4f86d69935c71f07013c1d8) chore: run go mod tidy
- [`68e355a`](https://github.com/jacaudi/nextdns-operator/commit/68e355a4c67e78993a7434fb96bc16c371748b3b) chore(deps): update GitHub Actions and Go toolchain
- [`5e21555`](https://github.com/jacaudi/nextdns-operator/commit/5e21555c788a822b8371e80ec9e646e8bccaa06e) chore(deps): update dependency go to v1.25.6
- [`b66f26a`](https://github.com/jacaudi/nextdns-operator/commit/b66f26a4e0798bf304f5156818453e6399b4fbd8) chore(deps): update golang docker tag to v1.25.6
- [`a2bd8a8`](https://github.com/jacaudi/nextdns-operator/commit/a2bd8a8290c423d383bee82048201e743b71dcdc) ci: add concurrency control to prevent parallel releases
...
- [`feb3860`](https://github.com/jacaudi/nextdns-operator/commit/feb38601d34a9178aea55ac1e6ae0ce1357a5ce4) refactor(client): add DomainEntry type for active state tracking
- [`bab0743`](https://github.com/jacaudi/nextdns-operator/commit/bab07431332b724d7e4682fd991bb3f3f95b8457) fix(rbac): add full CRUD permissions for list CRDs
- [`ca1ead3`](https://github.com/jacaudi/nextdns-operator/commit/ca1ead37f1d4d8f3715a787f756dfe3edfdee0a6) fix(chart): increase default memory limits to prevent OOMKilled
- [`d2cfc4e`](https://github.com/jacaudi/nextdns-operator/commit/d2cfc4ef136be34c5d93cf032677e5e0fce20634) Add renovate.json
...
- [`ca1ead3`](https://github.com/jacaudi/nextdns-operator/commit/ca1ead37f1d4d8f3715a787f756dfe3edfdee0a6) fix(chart): increase default memory limits to prevent OOMKilled
- [`d2cfc4e`](https://github.com/jacaudi/nextdns-operator/commit/d2cfc4ef136be34c5d93cf032677e5e0fce20634) Add renovate.json
- [`8476be1`](https://github.com/jacaudi/nextdns-operator/commit/8476be19f798927735b3dc15d6d7befeb7bc3717) fix(chart): correct RBAC and ServiceAccount structure for bjw-s common library
- [`d707324`](https://github.com/jacaudi/nextdns-operator/commit/d707324f21df02a6dcc71b4f148982fe2ac1714b) fix(chart): add v prefix to appVersion to match container image tag
- [`17c571c`](https://github.com/jacaudi/nextdns-operator/commit/17c571c513e8e1596ba66563776e89078afe2332) fix: update github-actions to v0.5.2
- [`e5f8a14`](https://github.com/jacaudi/nextdns-operator/commit/e5f8a148c66621cb5ad1a8b009b302db036a50e5) fix: update github-actions to v0.5.1
- [`3c06937`](https://github.com/jacaudi/nextdns-operator/commit/3c06937064aca4ae3833783cff322587567a72cb) fix: add packages:read permission for image-scan job
- [`0360930`](https://github.com/jacaudi/nextdns-operator/commit/03609309ab03fa26c00991e72f44712f8a68e17e) fix: update github-actions to v0.5.0
- [`a0c8b17`](https://github.com/jacaudi/nextdns-operator/commit/a0c8b1715c9393d493d0eefeb8325a3bfc696782) feat: update github-actions to v0.4.5
- [`a3b1ac4`](https://github.com/jacaudi/nextdns-operator/commit/a3b1ac4f2bb933d0b124ae052038500c48e3f9f8) feat: initial release with full operator implementation
- [`71fa0a7`](https://github.com/jacaudi/nextdns-operator/commit/71fa0a75577956e99f98db6266c8c1cd8339a7d3) fix: convert .semrelrc to JSON format
- [`54de53d`](https://github.com/jacaudi/nextdns-operator/commit/54de53d981175927bddd4dfa88155e18e97b4386) fix: rename .semrelrc to .semrelrc.yaml for YAML parsing
- [`2265470`](https://github.com/jacaudi/nextdns-operator/commit/2265470865f7c74c44396c706119d45efc6acda3) fix: remove app-version input from helm-publish job
- [`de05439`](https://github.com/jacaudi/nextdns-operator/commit/de05439d670296713f4a28ba386c05a5d02d3174) fix: remove optional image-digest parameter from scan job
- [`ed20aa3`](https://github.com/jacaudi/nextdns-operator/commit/ed20aa38de7ed574667c6aa0f3b1c9dfc5f569c8) fix: use correct exit-code input for image-scan workflow
- [`2a71a96`](https://github.com/jacaudi/nextdns-operator/commit/2a71a9616aebccb90c6cc62f45f46ae21b391a32) Implement NextDNS Kubernetes operator with full API coverage and CI/CD (#1)
- [`9aa2258`](https://github.com/jacaudi/nextdns-operator/commit/9aa2258848f6537d17f82fa23c47fd69204ce214) Initial commit
